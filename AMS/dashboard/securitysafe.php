...
<head>
    ...
    <title>NCC AMS - Security Safe</title>
...
<a class="collapse-item" href="monitors.php">Monitors</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Security Safe</h1>
                    <p class="mb-4">security safe</p>
    ...
    <div class="card-body">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card-body">
                ...
                <a href="print_security_safe.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="height10">
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_modal_securitysafe.php');
                            }
                            /////////////////
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="http://localhost/AMS/login/">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php include('add_modal_securitysafe.php') ?>
