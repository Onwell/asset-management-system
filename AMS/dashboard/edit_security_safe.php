<?php
	...
	if(isset($_POST['edit'])){
		...
		///////////////
			...
			$_SESSION['error'] = 'Something went wrong in updating Security Safe';
		}
	}
	else{
		$_SESSION['error'] = 'Select Security Safe to edit first';
	}
