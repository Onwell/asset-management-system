...
<a class="collapse-item" href="monitors.php">Monitors</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Heaters</h1>
                    <p class="mb-4"></p>
    ...
    <div class="card-body">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card-body">
                ...
                <a href="print_heaters.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="height10">
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_modal_heaters.php');
                            }
                            /////////////////
    ...
    <?php include('add_modal_heaters.php') ?>
