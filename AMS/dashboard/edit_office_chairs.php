<?php
	...
	if(isset($_POST['edit'])){
		...
		///////////////
			...
			$_SESSION['error'] = 'Something went wrong in updating Office Chairs';
		}
	}
	else{
		$_SESSION['error'] = 'Select Office Chairs to edit first';
	}

	header('location: http://ams.ncc-zim.co.zw/AMS/dashboard/officechairs.php');
