<?php
	...
	if(isset($_POST['edit'])){
		...
		///////////////
			...
			$_SESSION['error'] = 'Something went wrong in updating Projector';
		}
	}
	else{
		$_SESSION['error'] = 'Select Projector to edit first';
	}
