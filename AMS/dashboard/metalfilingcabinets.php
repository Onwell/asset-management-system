...
<head>
    ...
    <title>NCC AMS - Metal Filing Cabinets</title>
...
<a class="collapse-item" href="metalfilingcabinets.php">Metal Filing Cabinets</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">metalfilingcabinets</h1>
                    <p class="mb-4"></p>
    ...
    <div class="card-body">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card-body">
                ...
                <a href="print_metalfilingcabinets.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="height10">
            </div>
            <div class="card-body">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM metalfilingcabinet";
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_modal_metalfilingcabinets.php');
                            }
    ...
    <?php include('add_modal_metalfilingcabinets.php') ?>
