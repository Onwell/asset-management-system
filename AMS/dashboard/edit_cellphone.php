<?php
	...
	if(isset($_POST['edit'])){
		...
		///////////////
			...
			$_SESSION['error'] = 'Something went wrong in updating Cellphone';
		}
	}
	else{
		$_SESSION['error'] = 'Select cellphone to edit first';
	}
