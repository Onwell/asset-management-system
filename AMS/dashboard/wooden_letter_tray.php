...
<head>
    ...
    <title>NCC AMS - Wooden letter tray</title>
...
<a class="collapse-item" href="wooden_letter_tray.php">Wooden Tray Letter</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Wooden Letter Tray</h1>
                    <p class="mb-4"></p>
    ...
    <div class="card-body">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card-body">
                ...
                <a href="print_wooden_letter_tray.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="height10">
            </div>
            <div class="card-body">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM Wooden_Letter_Tray";
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_modal_letter_tray.php');
                            }
    ...
    <?php include('add_modal_letter_tray.php') ?>
