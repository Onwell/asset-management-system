<?php
	...
	if(isset($_POST['edit'])){
		...
		///////////////
			...
			$_SESSION['error'] = 'Something went wrong in updating Heater';
		}
	}
	else{
		$_SESSION['error'] = 'Select Heater to edit first';
	}
