...
<a class="collapse-item" href="shredder.php">Shredder</a>
    ...
    <div class="card-body">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card-body">
                ...
                <a href="print_table.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="height10">
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_modal_table.php');
                            }
    ...
    <?php include('add_modal_table.php') ?>
